...
?>
          <td<?= !empty($column['width']) ? " colspan='${column['width']}'" : "" ?><?= !empty($column['clean_value']) ? " data-list-${column['column_name']}='${column['clean_value']}'" : "" ?> class="<?= !empty($column['header']) ? 'report_body_header' : "" ?><?= !empty($column['column_name']) ? " list_${column['column_name']}" : "" ?>"><?= !empty($column['link']) ? "<a href='${column['link']}'>" : "" ?><?= $column['value'] ?><?= !empty($column['link']) ? "</a>" : "" ?></td>
<?php
       }
?>
        </tr>
