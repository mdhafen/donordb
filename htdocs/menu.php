...
<li><a href="<?= $data['_config']['base_url'] ?>actions.php">Actions</a></li>
<?php } ?>

<?php if ( !empty($data['_session']['CAN_accounts']) ) { ?>
<li><a href="<?= $data['_config']['base_url'] ?>accounts.php">Accounts</a></li>
<?php } ?>

<?php if ( !empty($data['_session']['CAN_contacts']) ) { ?>
<li><a href="<?= $data['_config']['base_url'] ?>contacts.php">Contacts</a></li>
<?php } ?>

<?php if ( !empty($data['_session']['CAN_reports']) ) { ?>
<li><a href="<?= $data['_config']['base_url'] ?>reports.php">Reports</a></li>
<?php } ?>
